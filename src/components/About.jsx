    ...
    return ( 
        ...
        <div className="container">
            <div className='about'>
                ...
                <div className="bio">
                <p>As a rising Junior studying Applied Math-Computer Science at Brown University, I'm passionate about solving complex problems and working collaboratively with a focus on software engineering and data science.</p> 
                ...
                <p>Thanks for visiting; let's connect :)</p>
                </div>
            </div>
        </div>
